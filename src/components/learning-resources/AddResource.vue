...
export default {
  ...
  methods: {
    submitData() {
      ...
      const enderedDescription = this.$refs.descInput.value;
      const enteredUrl = this.$refs.linkInput.value;

      if (enteredTitle.trim() === '' || enderedDescription.trim() === '' || enteredUrl.trim() === '') {
        this.inputIsInvalid = true;
        return;

      }

      this.addResource(enteredTitle, enderedDescription, enteredUrl);
    },
    confirmError() {
